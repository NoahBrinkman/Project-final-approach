namespace GXPEngine.Scenes
{
    public class LevelSelectScene : Scene
    {
        ...
        public LevelSelectScene() : base()
        {
            ...
            AddChild(bg);
            Sprite selectLevelText = new Sprite("SelectLevelText.png");
            ...
            Sprite lockedLevelTwo = new Sprite("Locked_Level.png");
